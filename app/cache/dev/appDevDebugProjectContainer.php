...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/annotations', true);
    }
    ...
    {
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($this->get('templating.loader'), '', 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_638e3237b39b44bb93d3722b68ae9ae0');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_638e3237b39b44bb93d3722b68ae9ae0');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_638e3237b39b44bb93d3722b68ae9ae0');
        ...
        $d->setProxyDir('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/assetic/routing.yml', array('cache_dir' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['sensio_distribution.webconfigurator'] = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app');
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/sessions');
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app', 'UTF-8');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\SecurityBundle/Resources/views', 'Security');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\TwigBundle/Resources/views', 'Twig');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\swiftmailer-bundle\\Symfony\\Bundle\\SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\doctrine\\doctrine-bundle\\Doctrine\\Bundle\\DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\src\\Acme\\DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\symfony\\src\\Symfony\\Bundle\\WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\sensio\\distribution-bundle\\Sensio\\Bundle\\DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/Resources/views');
        $instance->addPath('D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\symfony\\src\\Symfony\\Bridge\\Twig/Resources/views/Form');
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev');
    }
    ...
    {
        return $this->services['validator.mapping.class_metadata_factory'] = new \Symfony\Component\Validator\Mapping\ClassMetadataFactory(new \Symfony\Component\Validator\Mapping\Loader\LoaderChain(array(0 => new \Symfony\Component\Validator\Mapping\Loader\AnnotationLoader($this->get('annotation_reader')), 1 => new \Symfony\Component\Validator\Mapping\Loader\StaticMethodLoader(), 2 => new \Symfony\Component\Validator\Mapping\Loader\XmlFilesLoader(array(0 => 'D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml')), 3 => new \Symfony\Component\Validator\Mapping\Loader\YamlFilesLoader(array()))), NULL);
    }
    ...
    {
        return array(
            'kernel.root_dir' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev',
            'kernel.logs_dir' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/logs',
            ...
            'debug.container.dump' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/appDevDebugProjectContainer.xml',
            ...
            'session.save_path' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/sessions',
            ...
            'validator.mapping.loader.xml_files_loader.mapping_files' => array(
                0 => 'D:\\Public Library\\Marios\\thesis\\construction\\source\\msOAuth-php\\vendor\\symfony\\symfony\\src\\Symfony\\Component\\Form/Resources/config/validation.xml',
            ),
            ...
            'profiler.storage.dsn' => 'file:D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/profiler',
            ...
            'router.resource' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.memory.path' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/swiftmailer/spool',
            ...
            'assetic.cache_dir' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/assetic',
            ...
            'assetic.read_from' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/../web',
            'assetic.write_to' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/../web',
            ...
            'doctrine.orm.proxy_dir' => 'D:/Public Library/Marios/thesis/construction/source/msOAuth-php/app/cache/dev/doctrine/orm/Proxies',
